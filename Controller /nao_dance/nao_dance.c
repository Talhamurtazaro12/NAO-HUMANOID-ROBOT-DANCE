...
int main() {
  ...
  printf("NAO ULTIMATE BHANGRA DANCE STARTED!\n");
  ...
  // Reset posture
  wb_motor_set_position(LShoulderPitch, 1.5);
  wb_motor_set_position(RShoulderPitch, 1.5);
  ...
  printf("NAO ULTIMATE BHANGRA DANCE COMPLETED!\n");
